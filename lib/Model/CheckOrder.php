 ...
 * @link     https://openapi-generator.tech
 */
class CheckOrder implements ModelInterface, ArrayAccess
{
     ...
     * Sets order_id
     *
     * @param string $order_id Номер заказа в системе Мерчанта.<br><i>Не является уникальным идентификатором.</i>
     *
     * @return $this
     */
