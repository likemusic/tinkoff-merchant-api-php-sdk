...
/**
 * TinkoffPayEvent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TinkoffPayEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TinkoffPayEvent';
     ...
     * Gets event_data
     *
     * @return \OpenAPI\Client\Model\EventData
     */
     ...
     * Sets event_data
     *
     * @param \OpenAPI\Client\Model\EventData $event_data event_data
     *
     * @return $this
     */
     ...
     * Sets payment_id
     *
     * @param float|null $payment_id Идентификатор платежа
     *
     * @return $this
     */
