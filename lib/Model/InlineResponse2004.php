...
class InlineResponse2004 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rebill_id'] = isset($data['rebill_id']) ? $data['rebill_id'] : null;
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling InlineResponse2004., must be smaller than or equal to 20.');
        }
    ...
    public function setCustomerKey($customer_key)
    {
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling InlineResponse2004., must be smaller than or equal to 36.');
        }
     ...
     * Sets card_id
     *
     * @param string $card_id Идентификатор карты в системе Тинькофф Кассы
     *
     * @return $this
     */
    public function setCardId($card_id)
    {
        if ((mb_strlen($card_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $card_id when calling InlineResponse2004., must be smaller than or equal to 40.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling InlineResponse2004., must be smaller than or equal to 20.');
        }
    ...
    public function setStatus($status)
    {
        if (!is_null($status) && (mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling InlineResponse2004., must be smaller than or equal to 20.');
        }
