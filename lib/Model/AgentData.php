 ...
 * @link     https://openapi-generator.tech
 */
class AgentData implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['agent_sign'] = isset($data['agent_sign']) ? $data['agent_sign'] : null;
        ...
        $this->container['receiver_phones'] = isset($data['receiver_phones']) ? $data['receiver_phones'] : null;
        $this->container['transfer_phones'] = isset($data['transfer_phones']) ? $data['transfer_phones'] : null;
        $this->container['operator_name'] = isset($data['operator_name']) ? $data['operator_name'] : null;
        $this->container['operator_address'] = isset($data['operator_address']) ? $data['operator_address'] : null;
        $this->container['operator_inn'] = isset($data['operator_inn']) ? $data['operator_inn'] : null;
    }
     ...
     * Sets agent_sign
     *
     * @param string|null $agent_sign Признак агента. Возможные значения: * bank_paying_agent – банковский платежный агент * bank_paying_subagent – банковский платежный субагент * paying_agent – платежный агент * paying_subagent – платежный субагент * attorney – поверенный * commission_agent – комиссионер * another – другой тип агента
     *
     * @return $this
     */
     ...
     * Sets operation_name
     *
     * @param string|null $operation_name Наименование операции. Атрибут обязателен, если AgentSign передан в значениях: * bank_paying_agent * bank_paying_subagent
     *
     * @return $this
     */
     ...
     * Sets phones
     *
     * @param string[]|null $phones Телефоны платежного агента, в формате +{Ц}. Атрибут обязателен, если в AgentSign передан в значениях: * bank_paying_agent * bank_paying_subagent * paying_agent * paying_subagent
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $receiver_phones Телефоны оператора по приему платежей, в формате +{Ц}. Атрибут обязателен, если в AgentSign передан в значениях: * paying_agent * paying_subagent
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $transfer_phones Телефоны оператора перевода, в формате +{Ц}. Атрибут обязателен, если в AgentSign передан в значениях: * bank_paying_agent * bank_paying_subagent
     *
     * @return $this
     */
     ...
     * Sets operator_name
     *
     * @param string|null $operator_name Наименование оператора перевода. Атрибут обязателен, если в AgentSign передан в значениях: * bank_paying_agent * bank_paying_subagent
     *
     * @return $this
     */
     ...
     *
     * @param string|null $operator_address Адрес оператора перевода. Атрибут обязателен, если в AgentSign передан в значениях: * bank_paying_agent * bank_paying_subagent
     *
     * @return $this
     */
     ...
     * Sets operator_inn
     *
     * @param string|null $operator_inn ИНН оператора перевода. Атрибут обязателен, если в AgentSign передан в значениях: * bank_paying_agent * bank_paying_subagent
     *
     * @return $this
     */
