 ...
 *
 * @category Class
 * @description **Нотификация о фискацизации**  Если используется подключенная онлайн касса, по результату фискализации будет отправлена нотификация с фискальными данными.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NotificationFiscalization implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPIFormats = [
        ...
        'fiscal_document_attribute' => 'int32',
        'receipt' => null,
        'type' => null,
        'token' => null,
        'ofd' => null,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status'] = isset($data['status']) ? $data['status'] : 'RECEIPT';
        $this->container['payment_id'] = isset($data['payment_id']) ? $data['payment_id'] : null;
        $this->container['error_code'] = isset($data['error_code']) ? $data['error_code'] : null;
        $this->container['error_message'] = isset($data['error_message']) ? $data['error_message'] : null;
        $this->container['amount'] = isset($data['amount']) ? $data['amount'] : null;
        $this->container['fiscal_number'] = isset($data['fiscal_number']) ? $data['fiscal_number'] : null;
        $this->container['shift_number'] = isset($data['shift_number']) ? $data['shift_number'] : null;
        $this->container['receipt_datetime'] = isset($data['receipt_datetime']) ? $data['receipt_datetime'] : null;
        $this->container['fn_number'] = isset($data['fn_number']) ? $data['fn_number'] : null;
        $this->container['ecr_reg_number'] = isset($data['ecr_reg_number']) ? $data['ecr_reg_number'] : null;
        $this->container['fiscal_document_number'] = isset($data['fiscal_document_number']) ? $data['fiscal_document_number'] : null;
        $this->container['fiscal_document_attribute'] = isset($data['fiscal_document_attribute']) ? $data['fiscal_document_attribute'] : null;
        $this->container['receipt'] = isset($data['receipt']) ? $data['receipt'] : null;
        $this->container['type'] = isset($data['type']) ? $data['type'] : null;
        $this->container['token'] = isset($data['token']) ? $data['token'] : null;
        $this->container['ofd'] = isset($data['ofd']) ? $data['ofd'] : null;
        $this->container['url'] = isset($data['url']) ? $data['url'] : null;
        $this->container['qr_code_url'] = isset($data['qr_code_url']) ? $data['qr_code_url'] : null;
        $this->container['calculation_place'] = isset($data['calculation_place']) ? $data['calculation_place'] : null;
        $this->container['cashier_name'] = isset($data['cashier_name']) ? $data['cashier_name'] : null;
        $this->container['settle_place'] = isset($data['settle_place']) ? $data['settle_place'] : null;
    }
     ...
     * Sets terminal_key
     *
     * @param string|null $terminal_key Идентификатор терминала. Выдается Мерчанту Тинькофф Кассой при заведении терминала.
     *
     * @return $this
     */
     ...
     * Sets success
     *
     * @param bool|null $success Выполнение платежа
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Для нотификации о фискализации значение всегда RECEIPT
     *
     * @return $this
     */
     ...
     * Sets payment_id
     *
     * @param float|null $payment_id Идентификатор платежа в системе Тинькофф Кассы
     *
     * @return $this
     */
     ...
     * Sets receipt
     *
     * @param object|null $receipt Состав чека
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param string|null $token Подпись запроса. Формируется по такому же принципу, как и в случае запросов в Тинькофф Кассу
     *
     * @return $this
     */
