...
class PaymentData implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'data' => 'object',
        'receipt' => '\OpenAPI\Client\Model\ReceiptFFD105'
    ];
     ...
     * Sets amount
     *
     * @param float $amount Сумма в копейках. Параметр \"Amount\" должен быть равен сумме всех параметров \"Amount\", переданных в объекте Items
     *
     * @return $this
     */
     ...
     * Sets order_id
     *
     * @param string|null $order_id Уникальный номер заказа в системе Мерчанта
     *
     * @return $this
     */
     ...
     * Sets data
     *
     * @param object|null $data JSON объект, содержащии дополнительные параметры в виде \"ключ\" - «значение». Данные параметры будут переданы на страницу оплаты (в случае ее кастомизации). <br> Максимальная длина для каждого передаваемого параметра! <br> ключ - 20 знаков; <br> значение - 100 знаков. <br> Максимальное количество пар «ключ значение» не может превышать 20.
     *
     * @return $this
     */
     ...
     * Gets receipt
     *
     * @return \OpenAPI\Client\Model\ReceiptFFD105|null
     */
     ...
     * Sets receipt
     *
     * @param \OpenAPI\Client\Model\ReceiptFFD105|null $receipt receipt
     *
     * @return $this
     */
