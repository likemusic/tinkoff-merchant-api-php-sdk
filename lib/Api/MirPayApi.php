...
class MirPayApi
{
     ...
     */
    public function getDeepLinkPost($get_deep_link)
    {
        list($response) = $this->getDeepLinkPostWithHttpInfo($get_deep_link);
        return $response;
    }

    /**
     * Operation getDeepLinkPostWithHttpInfo
     *
     * Получить DeepLink
     *
     ...
     */
    public function getDeepLinkPostWithHttpInfo($get_deep_link)
    {
        $request = $this->getDeepLinkPostRequest($get_deep_link);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetDeepLinkResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetDeepLinkResponse', []),
    ...
    /**
     * Operation getDeepLinkPostAsync
     *
     * Получить DeepLink
     *
     * @param  \OpenAPI\Client\Model\GetDeepLink $get_deep_link (required)
     ...
     */
    public function getDeepLinkPostAsync($get_deep_link)
    {
        return $this->getDeepLinkPostAsyncWithHttpInfo($get_deep_link)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDeepLinkPostAsyncWithHttpInfo
     *
     * Получить DeepLink
     *
     * @param  \OpenAPI\Client\Model\GetDeepLink $get_deep_link (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeepLinkPostAsyncWithHttpInfo($get_deep_link)
    {
        $returnType = '\OpenAPI\Client\Model\GetDeepLinkResponse';
        $request = $this->getDeepLinkPostRequest($get_deep_link);
    ...
    /**
     * Create request for operation 'getDeepLinkPost'
     *
     * @param  \OpenAPI\Client\Model\GetDeepLink $get_deep_link (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getDeepLinkPostRequest($get_deep_link)
    {
        ...
        if ($get_deep_link === null || (is_array($get_deep_link) && count($get_deep_link) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $get_deep_link when calling getDeepLinkPost'
            );
        }

        $resourcePath = '/GetDeepLink';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getTerminalPayMethods($get_terminal_pay_methods)
    {
        list($response) = $this->getTerminalPayMethodsWithHttpInfo($get_terminal_pay_methods);
        return $response;
    }
     ...
     */
    public function getTerminalPayMethodsWithHttpInfo($get_terminal_pay_methods)
    {
        $request = $this->getTerminalPayMethodsRequest($get_terminal_pay_methods);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetTerminalPayMethodsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetTerminalPayMethodsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTerminalPayMethodsAsync($get_terminal_pay_methods)
    {
        return $this->getTerminalPayMethodsAsyncWithHttpInfo($get_terminal_pay_methods)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTerminalPayMethodsAsyncWithHttpInfo($get_terminal_pay_methods)
    {
        $returnType = '\OpenAPI\Client\Model\GetTerminalPayMethodsResponse';
        $request = $this->getTerminalPayMethodsRequest($get_terminal_pay_methods);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTerminalPayMethodsRequest($get_terminal_pay_methods)
    {
        ...
        $resourcePath = '/GetTerminalPayMethods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($get_terminal_pay_methods)) {
            $_tempBody = $get_terminal_pay_methods;
        }
