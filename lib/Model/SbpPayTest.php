 ...
 * @link     https://openapi-generator.tech
 */
class SbpPayTest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_deadline_expired'] = isset($data['is_deadline_expired']) ? $data['is_deadline_expired'] : null;
        $this->container['is_rejected'] = isset($data['is_rejected']) ? $data['is_rejected'] : null;
    }
     ...
     *
     * @param bool|null $is_deadline_expired Признак эмуляции отказа проведения платежа Банком по таймауту. По умолчанию не используется (эмуляция не требуется). * false – эмуляция не требуется * true – требуется эмуляция (не может быть использован вместе с IsRejected = true)
     *
     * @return $this
     */
     ...
     * Sets is_rejected
     *
     * @param bool|null $is_rejected Признак эмуляции отказа Банка в проведении платежа По умолчанию не используется (эмуляция не требуется) * false – эмуляция не требуется * true – требуется эмуляция (не может быть использован вместе с IsDeadlineExpired = true)
     *
     * @return $this
     */
