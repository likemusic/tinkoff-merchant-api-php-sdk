 ...
 * @link     https://openapi-generator.tech
 */
class With3DSv2APP extends FinishAuthorize 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'With3DSv2(APP)';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tds_server_trans_id'] = isset($data['tds_server_trans_id']) ? $data['tds_server_trans_id'] : null;
        $this->container['acs_trans_id'] = isset($data['acs_trans_id']) ? $data['acs_trans_id'] : null;
        $this->container['acs_interface'] = isset($data['acs_interface']) ? $data['acs_interface'] : null;
        $this->container['acs_ui_template'] = isset($data['acs_ui_template']) ? $data['acs_ui_template'] : null;
        $this->container['acs_signed_content'] = isset($data['acs_signed_content']) ? $data['acs_signed_content'] : null;
        $this->container['acs_reference_number'] = isset($data['acs_reference_number']) ? $data['acs_reference_number'] : null;
     ...
     * Sets acs_interface
     *
     * @param string|null $acs_interface `Обязательное поле, если Transaction Status = C`<br> Тип пользовательского интерфейса ACS. <br> Возможные значения:   - 01 - Native UI   - 02 - HTML UI
     *
     * @return $this
     */
     ...
     *
     * @param string|null $acs_ui_template `Обязательное поле, если Transaction Status = C`<br> Формат шаблона пользовательского интерфейса ACS. <br> Возможные значения:    - 01 - Text   - 02 - Single Select   - 03 - Multi Select   - 04 - OOB   - 05 - HTML Other (valid only for HTML UI)
     *
     * @return $this
     */
     ...
     *
     * @param string|null $acs_signed_content `Обязательное поле, если Transaction Status = C`<br> JWS object (представленный как string), созданный ACS для ARes. <br> Содержит:   - ACS URL (3DS SDK должен отправить Challenge Request на этот URL)   - ACS Ephemeral Public Key (QT)   - SDK Ephemeral Public Key (QC)
     *
     * @return $this
     */
     ...
     * Sets sdk_trans_id
     *
     * @param string $sdk_trans_id Уникальный идентификатор транзакции,назначенный 3DS SDK для идентификации одной транзакции,полученный в ответе на FinishAuthorize
     *
     * @return $this
     */
