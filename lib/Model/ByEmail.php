 ...
 * @link     https://openapi-generator.tech
 */
class ByEmail implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param float[] $payment_id_list Json-массив, содержащий в себе перечень paymentID (уникальных идентификаторов в системе Тинькофф Кассы) c типом Number
     *
     * @return $this
     */
     ...
     * Sets email_list
     *
     * @param string[] $email_list Json-массив, содержащий перечень E-mail с типом String
     *
     * @return $this
     */
