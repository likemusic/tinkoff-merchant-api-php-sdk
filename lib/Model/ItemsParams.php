 ...
 * @link     https://openapi-generator.tech
 */
class ItemsParams implements ModelInterface, ArrayAccess
{
     ...
     * Sets route
     *
     * @param string|null $route Способ платежа (ТСВ)
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string|null $source Источник платежа (installment)
     *
     * @return $this
     */
     ...
     * Sets credit_amount
     *
     * @param float|null $credit_amount Сумма выданного кредита в копейках
     *
     * @return $this
     */
