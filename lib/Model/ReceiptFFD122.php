 ...
 * @link     https://openapi-generator.tech
 */
class ReceiptFFD122 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['ffd_version'] = isset($data['ffd_version']) ? $data['ffd_version'] : null;
        ...
        $this->container['customer_inn'] = isset($data['customer_inn']) ? $data['customer_inn'] : null;
