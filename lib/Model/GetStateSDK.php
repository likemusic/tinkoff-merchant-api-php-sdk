 ...
 * @link     https://openapi-generator.tech
 */
class GetStateSDK implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetState_SDK';
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling GetStateSDK., must be smaller than or equal to 20.');
        }
