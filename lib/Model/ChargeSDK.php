 ...
 * @link     https://openapi-generator.tech
 */
class ChargeSDK implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Charge_SDK';
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling ChargeSDK., must be smaller than or equal to 20.');
        }
     ...
     * Sets rebill_id
     *
     * @param string $rebill_id Идентификатор рекуррентного платежа
     *
     * @return $this
     */
