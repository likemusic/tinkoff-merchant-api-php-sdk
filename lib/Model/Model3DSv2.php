 ...
 * @link     https://openapi-generator.tech
 */
class Model3DSv2 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['three_ds_comp_ind'] = isset($data['three_ds_comp_ind']) ? $data['three_ds_comp_ind'] : null;
        ...
        $this->container['cres_callback_url'] = isset($data['cres_callback_url']) ? $data['cres_callback_url'] : null;
        $this->container['color_depth'] = isset($data['color_depth']) ? $data['color_depth'] : '48';
        $this->container['java_enabled'] = isset($data['java_enabled']) ? $data['java_enabled'] : 'false';
    }
     ...
     *
     * @param string $three_ds_comp_ind `deviceChannel 02 - BRW`<br> Идентификатор выполнения 3DS Method: * 'Y' - выполнение метода успешно завершено * 'N' - выполнение метода завершено неуспешно или метод не выполнялся
     *
     * @return $this
     */
     ...
     * Sets language
     *
     * @param string $language `deviceChannel 02 - BRW`<br>  Язык браузера по формату IETF BCP47. Рекомендация по получению значения в браузере (из глобального объекта navigator):`navigator.language`
     *
     * @return $this
     */
     ...
     * Sets timezone
     *
     * @param string $timezone `deviceChannel 02 - BRW`<br> Time-zone пользователя в минутах. Рекомендация по получению значения в браузере: вызов метода `getTimezoneOffset()`
     *
     * @return $this
     */
     ...
     * Sets screen_height
     *
     * @param string $screen_height `deviceChannel 02 - BRW`<br> Высота экрана в пикселях. Рекомендация по получению значения в браузере (из глобального объекта screen): `screen.height`
     *
     * @return $this
     */
     ...
     * Sets screen_width
     *
     * @param string $screen_width `deviceChannel 02 - BRW`<br> Ширина экрана в пикселях. Рекомендация по получению значения в браузере (из глобального объекта screen): `screen.width`
     *
     * @return $this
     */
     ...
     *
     * @param string $cres_callback_url `deviceChannel 02 - BRW`<br> URL который будет использоваться для получения результата (CRES) после завершения Challenge Flow (аутентификаци с дополнительным переходом на страницу ACS)
     *
     * @return $this
     */
     ...
     * Sets color_depth
     *
     * @param string|null $color_depth `deviceChannel 02 - BRW`<br> Глубина цвета в битах. <br> Допустимые значения: 1/4/8/15/16/24/32/48 <br> Рекомендация по получению значения в браузере (из глобального объекта screen): `screen.colorDepth`
     *
     * @return $this
     */
     ...
     * Sets java_enabled
     *
     * @param string|null $java_enabled `deviceChannel 02 - BRW`<br> Поддерживает ли браузер пользователя Java:  * true * false
     *
     * @return $this
     */
