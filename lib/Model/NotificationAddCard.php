 ...
 * @link     https://openapi-generator.tech
 */
class NotificationAddCard implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string|null $status Статус привязки карты. Получает в ответе 1 из 2 статусов привязки:   * COMPLETED - при одностадийной оплате   * REJECTED - при двухстадийной оплате
     *
     * @return $this
     */
     ...
     * Sets card_id
     *
     * @param float|null $card_id Идентификатор карты в системе Тинькофф Кассы
     *
     * @return $this
     */
