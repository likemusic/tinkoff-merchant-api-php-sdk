...
class Class3DSApi
{
    ...
    /**
     * Operation submit3DSAuthorizationPost
     *
     * Подтверждение прохождения 3DS v1.0
     *
     * @param  string $md Уникальный идентификатор транзакции в системе Тинькофф Кассы (возвращается в ответе от ACS) (required)
     ...
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (optional)
     * @param  string $terminal_key Идентификатор терминала, выдается Мерчанту Тинькофф Кассой (optional)
     ...
     */
    public function submit3DSAuthorizationPost($md, $pa_res, $payment_id = null, $terminal_key = null, $token = null)
    {
        list($response) = $this->submit3DSAuthorizationPostWithHttpInfo($md, $pa_res, $payment_id, $terminal_key, $token);
        return $response;
    }

    /**
     * Operation submit3DSAuthorizationPostWithHttpInfo
     *
     * Подтверждение прохождения 3DS v1.0
     *
     * @param  string $md Уникальный идентификатор транзакции в системе Тинькофф Кассы (возвращается в ответе от ACS) (required)
     ...
     */
    public function submit3DSAuthorizationPostWithHttpInfo($md, $pa_res, $payment_id = null, $terminal_key = null, $token = null)
    {
        $request = $this->submit3DSAuthorizationPostRequest($md, $pa_res, $payment_id, $terminal_key, $token);
    ...
    /**
     * Operation submit3DSAuthorizationPostAsync
     *
     * Подтверждение прохождения 3DS v1.0
     *
     * @param  string $md Уникальный идентификатор транзакции в системе Тинькофф Кассы (возвращается в ответе от ACS) (required)
     ...
     */
    public function submit3DSAuthorizationPostAsync($md, $pa_res, $payment_id = null, $terminal_key = null, $token = null)
    {
        return $this->submit3DSAuthorizationPostAsyncWithHttpInfo($md, $pa_res, $payment_id, $terminal_key, $token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation submit3DSAuthorizationPostAsyncWithHttpInfo
     *
     * Подтверждение прохождения 3DS v1.0
     *
     * @param  string $md Уникальный идентификатор транзакции в системе Тинькофф Кассы (возвращается в ответе от ACS) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submit3DSAuthorizationPostAsyncWithHttpInfo($md, $pa_res, $payment_id = null, $terminal_key = null, $token = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2005';
        $request = $this->submit3DSAuthorizationPostRequest($md, $pa_res, $payment_id, $terminal_key, $token);
    ...
    /**
     * Create request for operation 'submit3DSAuthorizationPost'
     *
     * @param  string $md Уникальный идентификатор транзакции в системе Тинькофф Кассы (возвращается в ответе от ACS) (required)
     * @param  string $pa_res Шифрованная строка, содержащая результаты 3-D Secure аутентификации (возвращается в ответе от ACS) (required)
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (optional)
     ...
     */
    protected function submit3DSAuthorizationPostRequest($md, $pa_res, $payment_id = null, $terminal_key = null, $token = null)
    {
        // verify the required parameter 'md' is set
        if ($md === null || (is_array($md) && count($md) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $md when calling submit3DSAuthorizationPost'
            );
        }
        // verify the required parameter 'pa_res' is set
        if ($pa_res === null || (is_array($pa_res) && count($pa_res) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pa_res when calling submit3DSAuthorizationPost'
            );
        }
        if ($terminal_key !== null && strlen($terminal_key) > 20) {
            throw new \InvalidArgumentException('invalid length for "$terminal_key" when calling Class3DSApi.submit3DSAuthorizationPost, must be smaller than or equal to 20.');
        }


        $resourcePath = '/Submit3DSAuthorization';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation submit3DSAuthorizationV2Post
     *
     * Подтверждение прохождения 3DS v2.1
     *
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     * @param  string $terminal_key Идентификатор терминала, выдается Мерчанту Тинькофф Кассой (required)
     ...
     */
    public function submit3DSAuthorizationV2Post($payment_id, $terminal_key, $token)
    {
        list($response) = $this->submit3DSAuthorizationV2PostWithHttpInfo($payment_id, $terminal_key, $token);
        return $response;
    }

    /**
     * Operation submit3DSAuthorizationV2PostWithHttpInfo
     *
     * Подтверждение прохождения 3DS v2.1
     *
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     ...
     */
    public function submit3DSAuthorizationV2PostWithHttpInfo($payment_id, $terminal_key, $token)
    {
        $request = $this->submit3DSAuthorizationV2PostRequest($payment_id, $terminal_key, $token);
    ...
    /**
     * Operation submit3DSAuthorizationV2PostAsync
     *
     * Подтверждение прохождения 3DS v2.1
     *
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submit3DSAuthorizationV2PostAsync($payment_id, $terminal_key, $token)
    {
        return $this->submit3DSAuthorizationV2PostAsyncWithHttpInfo($payment_id, $terminal_key, $token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation submit3DSAuthorizationV2PostAsyncWithHttpInfo
     *
     * Подтверждение прохождения 3DS v2.1
     *
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submit3DSAuthorizationV2PostAsyncWithHttpInfo($payment_id, $terminal_key, $token)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2006';
        $request = $this->submit3DSAuthorizationV2PostRequest($payment_id, $terminal_key, $token);
    ...
    /**
     * Create request for operation 'submit3DSAuthorizationV2Post'
     *
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     * @param  string $terminal_key Идентификатор терминала, выдается Мерчанту Тинькофф Кассой (required)
     * @param  string $token Подпись запроса (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function submit3DSAuthorizationV2PostRequest($payment_id, $terminal_key, $token)
    {
        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling submit3DSAuthorizationV2Post'
            );
        }
        // verify the required parameter 'terminal_key' is set
        if ($terminal_key === null || (is_array($terminal_key) && count($terminal_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $terminal_key when calling submit3DSAuthorizationV2Post'
            );
        }
        if (strlen($terminal_key) > 20) {
            throw new \InvalidArgumentException('invalid length for "$terminal_key" when calling Class3DSApi.submit3DSAuthorizationV2Post, must be smaller than or equal to 20.');
        }

        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling submit3DSAuthorizationV2Post'
            );
        }

        $resourcePath = '/Submit3DSAuthorizationV2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
