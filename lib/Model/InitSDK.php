 ...
 * @link     https://openapi-generator.tech
 */
class InitSDK implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Init_SDK';
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling InitSDK., must be smaller than or equal to 20.');
        }
    ...
    public function setOrderId($order_id)
    {
        if ((mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling InitSDK., must be smaller than or equal to 36.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Описание заказа. Поле необходимо обязательно заполнять для осуществления привязки и одновременной оплаты по CБП.
     *
     * @return $this
     */
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 250)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InitSDK., must be smaller than or equal to 250.');
        }
     ...
     * Sets customer_key
     *
     * @param string|null $customer_key Идентификатор клиента в системе Мерчанта. * Обязателен, если передан атрибут `Recurrent`.  * Если был передан в запросе, в нотификации будет указан `CustomerKey` и его `CardId`. См. метод [GetCardList](#tag/Metody-raboty-s-kartami/paths/~1GetCardList/post). * Необходим для сохранения карт на платежной форме (платежи в один клик).
     *
     * @return $this
     */
    public function setCustomerKey($customer_key)
    {
        if (!is_null($customer_key) && (mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling InitSDK., must be smaller than or equal to 36.');
        }
    ...
    public function setRecurrent($recurrent)
    {
        if (!is_null($recurrent) && (mb_strlen($recurrent) > 1)) {
            throw new \InvalidArgumentException('invalid length for $recurrent when calling InitSDK., must be smaller than or equal to 1.');
        }
     ...
     * Sets pay_type
     *
     * @param string|null $pay_type Определяет тип проведения платежа – двухстадийная или одностадийная оплата. * \"O\" - одностадийная оплата, * \"T\" - двухстадийная оплата
     *
     * @return $this
     */
    ...
    public function setLanguage($language)
    {
        ...
        if (!is_null($language) && (mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling InitSDK., must be smaller than or equal to 2.');
        }
     ...
     * Sets success_url
     *
     * @param string|null $success_url URL на веб-сайте Мерчанта, куда будет переведен клиент в случае успешной оплаты (для установки обратитесь к персональному менеджеру) * Если параметр передан – используется также значение, установленное через менеджера (актуально для SDK)
     *
     * @return $this
     */
     ...
     * Sets fail_url
     *
     * @param string|null $fail_url URL на веб-сайте Мерчанта, куда будет переведен клиент в случае неуспешной оплаты (для установки обратитесь к персональному менеджеру) * Если параметр передан – используется также значение, установленное через менеджера (актуально для SDK)
     *
     * @return $this
     */
     ...
     * Sets receipt
     *
     * @param object|null $receipt JSON объект с данными чека
     *
     * @return $this
     */
     ...
     * Sets shops
     *
     * @param \OpenAPI\Client\Model\Shops[]|null $shops JSON объект с данными Маркетплейса
     *
     * @return $this
     */
