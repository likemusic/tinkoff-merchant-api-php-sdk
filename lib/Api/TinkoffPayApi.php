...
/**
 * TinkoffPayApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class TinkoffPayApi
{
    ...
    /**
     * Operation tinkoffPayEventPost
     *
     * Передача уведомления о событии
     *
     * @param  \OpenAPI\Client\Model\TinkoffPayEvent $tinkoff_pay_event tinkoff_pay_event (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse2009
     */
    public function tinkoffPayEventPost($tinkoff_pay_event)
    {
        list($response) = $this->tinkoffPayEventPostWithHttpInfo($tinkoff_pay_event);
        return $response;
    }

    /**
     * Operation tinkoffPayEventPostWithHttpInfo
     *
     * Передача уведомления о событии
     *
     * @param  \OpenAPI\Client\Model\TinkoffPayEvent $tinkoff_pay_event (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse2009, HTTP status code, HTTP response headers (array of strings)
     */
    public function tinkoffPayEventPostWithHttpInfo($tinkoff_pay_event)
    {
        $request = $this->tinkoffPayEventPostRequest($tinkoff_pay_event);
    ...
    /**
     * Operation tinkoffPayEventPostAsync
     *
     * Передача уведомления о событии
     *
     * @param  \OpenAPI\Client\Model\TinkoffPayEvent $tinkoff_pay_event (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tinkoffPayEventPostAsync($tinkoff_pay_event)
    {
        return $this->tinkoffPayEventPostAsyncWithHttpInfo($tinkoff_pay_event)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation tinkoffPayEventPostAsyncWithHttpInfo
     *
     * Передача уведомления о событии
     *
     * @param  \OpenAPI\Client\Model\TinkoffPayEvent $tinkoff_pay_event (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tinkoffPayEventPostAsyncWithHttpInfo($tinkoff_pay_event)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2009';
        $request = $this->tinkoffPayEventPostRequest($tinkoff_pay_event);
    ...
    /**
     * Create request for operation 'tinkoffPayEventPost'
     *
     * @param  \OpenAPI\Client\Model\TinkoffPayEvent $tinkoff_pay_event (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function tinkoffPayEventPostRequest($tinkoff_pay_event)
    {
        // verify the required parameter 'tinkoff_pay_event' is set
        if ($tinkoff_pay_event === null || (is_array($tinkoff_pay_event) && count($tinkoff_pay_event) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tinkoff_pay_event when calling tinkoffPayEventPost'
            );
        }

        $resourcePath = '/TinkoffPayEvent';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($tinkoff_pay_event)) {
            $_tempBody = $tinkoff_pay_event;
        }
    ...
    /**
     * Operation tinkoffPayPaymentIdQRGet
     *
     * Получение QR
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SplFileObject
     */
    public function tinkoffPayPaymentIdQRGet($payment_id)
    {
        list($response) = $this->tinkoffPayPaymentIdQRGetWithHttpInfo($payment_id);
        return $response;
    }

    /**
     * Operation tinkoffPayPaymentIdQRGetWithHttpInfo
     *
     * Получение QR
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     ...
     */
    public function tinkoffPayPaymentIdQRGetWithHttpInfo($payment_id)
    {
        $request = $this->tinkoffPayPaymentIdQRGetRequest($payment_id);
    ...
    /**
     * Operation tinkoffPayPaymentIdQRGetAsync
     *
     * Получение QR
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tinkoffPayPaymentIdQRGetAsync($payment_id)
    {
        return $this->tinkoffPayPaymentIdQRGetAsyncWithHttpInfo($payment_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation tinkoffPayPaymentIdQRGetAsyncWithHttpInfo
     *
     * Получение QR
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tinkoffPayPaymentIdQRGetAsyncWithHttpInfo($payment_id)
    {
        $returnType = '\SplFileObject';
        $request = $this->tinkoffPayPaymentIdQRGetRequest($payment_id);
    ...
    /**
     * Create request for operation 'tinkoffPayPaymentIdQRGet'
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function tinkoffPayPaymentIdQRGetRequest($payment_id)
    {
        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling tinkoffPayPaymentIdQRGet'
            );
        }

        $resourcePath = '/TinkoffPay/{paymentId}/QR';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation tinkoffPayTerminalsTerminalKeyStatusGet
     *
     * Статус
     *
     ...
     */
    public function tinkoffPayTerminalsTerminalKeyStatusGet($terminal_key)
    {
        list($response) = $this->tinkoffPayTerminalsTerminalKeyStatusGetWithHttpInfo($terminal_key);
        return $response;
    }

    /**
     * Operation tinkoffPayTerminalsTerminalKeyStatusGetWithHttpInfo
     *
     * Статус
     *
     * @param  string $terminal_key Платежный ключ, выдается Мерчанту при заведении терминала (required)
     ...
     */
    public function tinkoffPayTerminalsTerminalKeyStatusGetWithHttpInfo($terminal_key)
    {
        $request = $this->tinkoffPayTerminalsTerminalKeyStatusGetRequest($terminal_key);
    ...
    /**
     * Operation tinkoffPayTerminalsTerminalKeyStatusGetAsync
     *
     * Статус
     *
     * @param  string $terminal_key Платежный ключ, выдается Мерчанту при заведении терминала (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tinkoffPayTerminalsTerminalKeyStatusGetAsync($terminal_key)
    {
        return $this->tinkoffPayTerminalsTerminalKeyStatusGetAsyncWithHttpInfo($terminal_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation tinkoffPayTerminalsTerminalKeyStatusGetAsyncWithHttpInfo
     *
     * Статус
     *
     * @param  string $terminal_key Платежный ключ, выдается Мерчанту при заведении терминала (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tinkoffPayTerminalsTerminalKeyStatusGetAsyncWithHttpInfo($terminal_key)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2007';
        $request = $this->tinkoffPayTerminalsTerminalKeyStatusGetRequest($terminal_key);
    ...
    /**
     * Create request for operation 'tinkoffPayTerminalsTerminalKeyStatusGet'
     *
     * @param  string $terminal_key Платежный ключ, выдается Мерчанту при заведении терминала (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function tinkoffPayTerminalsTerminalKeyStatusGetRequest($terminal_key)
    {
        // verify the required parameter 'terminal_key' is set
        if ($terminal_key === null || (is_array($terminal_key) && count($terminal_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $terminal_key when calling tinkoffPayTerminalsTerminalKeyStatusGet'
            );
        }
        if (strlen($terminal_key) > 20) {
            throw new \InvalidArgumentException('invalid length for "$terminal_key" when calling TinkoffPayApi.tinkoffPayTerminalsTerminalKeyStatusGet, must be smaller than or equal to 20.');
        }


        $resourcePath = '/TinkoffPay/terminals/{TerminalKey}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation tinkoffPayTransactionsPaymentIdVersionsVersionLinkGet
     *
     * Получение ссылки
     *
     * @param  float $payment_id Идентификатор платежа в системе Тинькофф Кассы (required)
     * @param  string $version Версия Tinkoff Pay, доступная на терминале: * 1.0 (e-invoice) * 2.0 (Tinkoff Pay) (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse2008
     */
    public function tinkoffPayTransactionsPaymentIdVersionsVersionLinkGet($payment_id, $version)
    {
        list($response) = $this->tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetWithHttpInfo($payment_id, $version);
        return $response;
    }

    /**
     * Operation tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetWithHttpInfo
     *
     * Получение ссылки
     *
     * @param  float $payment_id Идентификатор платежа в системе Тинькофф Кассы (required)
     ...
     */
    public function tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetWithHttpInfo($payment_id, $version)
    {
        $request = $this->tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetRequest($payment_id, $version);
    ...
    /**
     * Operation tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetAsync
     *
     * Получение ссылки
     *
     * @param  float $payment_id Идентификатор платежа в системе Тинькофф Кассы (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetAsync($payment_id, $version)
    {
        return $this->tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetAsyncWithHttpInfo($payment_id, $version)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetAsyncWithHttpInfo
     *
     * Получение ссылки
     *
     * @param  float $payment_id Идентификатор платежа в системе Тинькофф Кассы (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetAsyncWithHttpInfo($payment_id, $version)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2008';
        $request = $this->tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetRequest($payment_id, $version);
    ...
    /**
     * Create request for operation 'tinkoffPayTransactionsPaymentIdVersionsVersionLinkGet'
     *
     * @param  float $payment_id Идентификатор платежа в системе Тинькофф Кассы (required)
     * @param  string $version Версия Tinkoff Pay, доступная на терминале: * 1.0 (e-invoice) * 2.0 (Tinkoff Pay) (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function tinkoffPayTransactionsPaymentIdVersionsVersionLinkGetRequest($payment_id, $version)
    {
        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling tinkoffPayTransactionsPaymentIdVersionsVersionLinkGet'
            );
        }
        if (strlen($payment_id) > 20) {
            throw new \InvalidArgumentException('invalid length for "$payment_id" when calling TinkoffPayApi.tinkoffPayTransactionsPaymentIdVersionsVersionLinkGet, must be smaller than or equal to 20.');
        }

        // verify the required parameter 'version' is set
        if ($version === null || (is_array($version) && count($version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $version when calling tinkoffPayTransactionsPaymentIdVersionsVersionLinkGet'
            );
        }

        $resourcePath = '/TinkoffPay/transactions/{paymentId}/versions/{version}/link';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
