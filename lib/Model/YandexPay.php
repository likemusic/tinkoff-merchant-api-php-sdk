 ...
 * @link     https://openapi-generator.tech
 */
class YandexPay implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'YandexPay';
    ...
    protected static $setters = [
        'yandex_pay_web' => 'setYandexPayWeb'
    ];
    ...
    protected static $getters = [
        'yandex_pay_web' => 'getYandexPayWeb'
    ];
    ...
    {
        $this->container['yandex_pay_web'] = isset($data['yandex_pay_web']) ? $data['yandex_pay_web'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['yandex_pay_web'] === null) {
            $invalidProperties[] = "'yandex_pay_web' can't be null";
        }
     ...
     * @return bool
     */
    public function getYandexPayWeb()
    {
        return $this->container['yandex_pay_web'];
    }

    /**
     * Sets yandex_pay_web
     *
     * @param bool $yandex_pay_web Признак проведения операции через Yandex Pay
     *
     * @return $this
     */
    public function setYandexPayWeb($yandex_pay_web)
    {
        $this->container['yandex_pay_web'] = $yandex_pay_web;
