 ...
 * @link     https://openapi-generator.tech
 */
class AttachCardResponse implements ModelInterface, ArrayAccess
{
    ...
    const STATUS__3_DS_CHECKING = '3DS_CHECKING';
    const STATUS__3_DS_CHECKED = '3DS_CHECKED';
     ...
     * Sets md
     *
     * @param string|null $md Уникальный идентификатор транзакции в системе Тинькофф Кассы (возвращается в ответе на статус 3DS_CHECKING)
     *
     * @return $this
     */
