 ...
 * @link     https://openapi-generator.tech
 */
class ChargeQrResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string|null $status Статус платежа   Получает в ответе 1 из 2 статусов: * CONFIRMED - Если платеж выполнен * REJECTED - Если платеж не выполнен
     *
     * @return $this
     */
     ...
     * Sets error_code
     *
     * @param string $error_code Код ошибки. * \"0\" - успешная операция; * \"3013\" - рекуррентные платежи недоступны; * \"3015\" - неверный статус AccountToken.
     *
     * @return $this
     */
