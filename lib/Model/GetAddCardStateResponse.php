 ...
 * @link     https://openapi-generator.tech
 */
class GetAddCardStateResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets card_id
     *
     * @param string|null $card_id Идентификатор карты в системе Тинькофф Кассы
     *
     * @return $this
     */
