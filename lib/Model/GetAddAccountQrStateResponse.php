 ...
 * @link     https://openapi-generator.tech
 */
class GetAddAccountQrStateResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets bank_member_id
     *
     * @param string|null $bank_member_id Идентификатор Банка клиента, который будет совершать оплату по привязаному счету - заполнен, если статус ACTIVE, INACTIVE
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Статус привязки карты: * NEW - получен запрос на привязку счета; * PROCESSING - запрос в обработке; * ACTIVE - привязка счета успешна; * INACTIVE - привязка счета неуспешна/деактивирована
     *
     * @return $this
     */
