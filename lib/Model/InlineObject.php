...
class InlineObject implements ModelInterface, ArrayAccess
{
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling InlineObject., must be smaller than or equal to 20.');
        }
     ...
     * Sets card_data
     *
     * @param object $card_data Зашифрованные данные карты в формате: ``` PAN=4300000000000777;ExpDate=0519;CardHolder=IVAN PETROV;CVV=111 ``` type: string
     *
     * @return $this
     */
