...
/**
 * TinkoffPayweb Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class TinkoffPayweb implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TinkoffPayweb';
    ...
    {
        $this->container['tinkoff_pay'] = isset($data['tinkoff_pay']) ? $data['tinkoff_pay'] : null;
    }
     ...
     * @return object|null
     */
    public function getTinkoffPay()
    {
        return $this->container['tinkoff_pay'];
    }

    /**
     * Sets tinkoff_pay
     *
     * @param object|null $tinkoff_pay Объект с информацией о Tinkoff Pay
     *
     * @return $this
     */
    public function setTinkoffPay($tinkoff_pay)
    {
        $this->container['tinkoff_pay'] = $tinkoff_pay;
