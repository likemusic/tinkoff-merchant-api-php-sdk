...
/**
 * PaymentInfos Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PaymentInfos implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInfos';
    ...
    protected static $openAPITypes = [
        'info_email' => 'string',
        'payment_data' => '\OpenAPI\Client\Model\PaymentData'
    ];
     ...
     * Sets info_email
     *
     * @param string|null $info_email Адрес электронной почты покупателя
     *
     * @return $this
     */
     ...
     * Gets payment_data
     *
     * @return \OpenAPI\Client\Model\PaymentData
     */
     ...
     * Sets payment_data
     *
     * @param \OpenAPI\Client\Model\PaymentData $payment_data payment_data
     *
     * @return $this
     */
