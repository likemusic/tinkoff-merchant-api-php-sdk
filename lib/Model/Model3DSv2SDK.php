...
/**
 * Model3DSv2SDK Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Model3DSv2SDK implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '3DSv2(SDK)';
    ...
    {
        $this->container['sdk_app_id'] = isset($data['sdk_app_id']) ? $data['sdk_app_id'] : null;
        $this->container['sdk_enc_data'] = isset($data['sdk_enc_data']) ? $data['sdk_enc_data'] : null;
        $this->container['sdk_ephem_pub_key'] = isset($data['sdk_ephem_pub_key']) ? $data['sdk_ephem_pub_key'] : null;
        $this->container['sdk_max_timeout'] = isset($data['sdk_max_timeout']) ? $data['sdk_max_timeout'] : null;
        $this->container['sdk_reference_number'] = isset($data['sdk_reference_number']) ? $data['sdk_reference_number'] : null;
        $this->container['sdk_trans_id'] = isset($data['sdk_trans_id']) ? $data['sdk_trans_id'] : null;
        $this->container['sdk_interface'] = isset($data['sdk_interface']) ? $data['sdk_interface'] : null;
        $this->container['sdk_ui_type'] = isset($data['sdk_ui_type']) ? $data['sdk_ui_type'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sdk_max_timeout'] === null) {
            $invalidProperties[] = "'sdk_max_timeout' can't be null";
        }
        if ((mb_strlen($this->container['sdk_max_timeout']) < 5)) {
            $invalidProperties[] = "invalid value for 'sdk_max_timeout', the character length must be bigger than or equal to 5.";
        }
        ...
        if ($this->container['sdk_interface'] === null) {
            $invalidProperties[] = "'sdk_interface' can't be null";
        }
        if ($this->container['sdk_ui_type'] === null) {
            $invalidProperties[] = "'sdk_ui_type' can't be null";
        }
     ...
     * Sets sdk_app_id
     *
     * @param string $sdk_app_id `deviceChannel 01 - APP`<br> Уникальный идентификатор приложения 3DS Requestor, который формируется 3DS SDK при каждой установке или обновлении приложения
     *
     * @return $this
     */
     ...
     * Sets sdk_enc_data
     *
     * @param string $sdk_enc_data `deviceChannel 01 - APP`<br> Данные, собранные SDK. <br> JWE объект, полученный от 3DS SDK. <br> Должен быть дополнительно закодирован в `base64` строку
     *
     * @return $this
     */
     ...
     *
     * @param string $sdk_ephem_pub_key `deviceChannel 01 - APP`<br> Компонент public key пары ephemeral key, сгенерированный 3DS SDK.  <br> JWE объект, полученный от 3DS SDK, должен быть дополнительно закодирован в `base64` строку
     *
     * @return $this
     */
     ...
     *
     * @param string $sdk_max_timeout `deviceChannel 01 - APP`<br> Максимальное количество времени (в минутах)
     *
     * @return $this
     */
    public function setSdkMaxTimeout($sdk_max_timeout)
    {
        ...
        if ((mb_strlen($sdk_max_timeout) < 5)) {
            throw new \InvalidArgumentException('invalid length for $sdk_max_timeout when calling Model3DSv2SDK., must be bigger than or equal to 5.');
        }
     ...
     *
     * @param string $sdk_reference_number `deviceChannel 01 - APP`<br> Поставщик и версия 3DS SDK
     *
     * @return $this
     */
     ...
     * Sets sdk_trans_id
     *
     * @param string $sdk_trans_id `deviceChannel 01 - APP`<br> Уникальный идентификатор транзакции, назначенный 3DS SDK для идентификации одной транзакции
     *
     * @return $this
     */
     ...
     * Sets sdk_interface
     *
     * @param string $sdk_interface `deviceChannel 01 - APP`<br> Список поддерживаемых интерфейсов SDK. <br> Поддерживаемые значения: * 01 = Native * 02 = HTML * 03 = Both
     *
     * @return $this
     */
     ...
     * Sets sdk_ui_type
     *
     * @param string $sdk_ui_type `deviceChannel 01 - APP`<br> Список поддерживаемых типов UI. <br> Значения для каждого интерфейса: * Native UI = 01–04 * HTML UI = 01–05 <br> Поддерживаемые значения: * 01 = Text * 02 = Single Select * 03 = Multi Select * 04 = OOB * 05 = HTML Other (valid only for HTML UI)
     *
     * @return $this
     */
