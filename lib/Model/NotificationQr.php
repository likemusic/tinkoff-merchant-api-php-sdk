 ...
 *
 * @category Class
 * @description **Нотификация о статусе привязки счета по QR**  После привязки счета по QR, магазину отправляется статус привязки и токен. Нотификация будет приходить по статусам **ACTIVE** и **INACTIVE**
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NotificationQr implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['account_token'] = isset($data['account_token']) ? $data['account_token'] : null;
        $this->container['bank_member_id'] = isset($data['bank_member_id']) ? $data['bank_member_id'] : null;
        $this->container['bank_member_name'] = isset($data['bank_member_name']) ? $data['bank_member_name'] : null;
        $this->container['notification_type'] = isset($data['notification_type']) ? $data['notification_type'] : 'LINKACCOUNT';
     ...
     * Sets bank_member_id
     *
     * @param string|null $bank_member_id Идентификатор банка-эмитента клиента, который будет совершать оплату по привязаному счету - заполнен, если статус ACTIVE
     *
     * @return $this
     */
     ...
     *
     * @param string|null $bank_member_name Наименование банка-эмитента, заполнен если BankMemberId передан
     *
     * @return $this
     */
     ...
     *
     * @param string $notification_type Тип нотификации, всегда константа «LINKACCOUNT»
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param string $token Подпись запроса. Формируется по такому же принципу, как и в случае запросов в Тинькофф Кассу
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Cтатус привязки
     *
     * @return $this
     */
