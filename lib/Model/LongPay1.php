 ...
 * @link     https://openapi-generator.tech
 */
class LongPay1 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ticket_reservation_number'] = isset($data['ticket_reservation_number']) ? $data['ticket_reservation_number'] : null;
        $this->container['ticket_system'] = isset($data['ticket_system']) ? $data['ticket_system'] : null;
        $this->container['ticket_agency_code'] = isset($data['ticket_agency_code']) ? $data['ticket_agency_code'] : null;
        $this->container['ticket_agency_name'] = isset($data['ticket_agency_name']) ? $data['ticket_agency_name'] : null;
        $this->container['ticket_restricted'] = isset($data['ticket_restricted']) ? $data['ticket_restricted'] : null;
    }
     ...
     * Sets ticket_number
     *
     * @param string|null $ticket_number Номера билетов (с контрольной цифрой) для всех пассажиров, летящих по одному маршруту. В качестве разделителя используйте ';'<br>Необязателен, если передан параметр ticketReservationNumber
     *
     * @return $this
     */
     ...
     *
     * @param string|null $ticket_reservation_number Номера билетов (с контрольной цифрой) для всех пассажиров, летящих по одному маршруту. В качестве разделителя используйте ';'<br>Необязателен, если передан параметр ticketNumber
     *
     * @return $this
     */
