 ...
 * @link     https://openapi-generator.tech
 */
class ReceiptFFD1052 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ffd_version'] = isset($data['ffd_version']) ? $data['ffd_version'] : '1.05';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['taxation']) && !in_array($this->container['taxation'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'taxation', must be one of '%s'",
     ...
     * Sets ffd_version
     *
     * @param string|null $ffd_version Версия ФФД. Возможные значения: * \"FfdVersion\": \"1.2\" * \"FfdVersion\": \"1.05\" По умолчанию версия ФФД - 1.05
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string|null $email Электронная почта клиента. Атрибут должен быть заполнен, если не передано значение  в атрибуте “Phone”
     *
     * @return $this
     */
     ...
     * Sets taxation
     *
     * @param string|null $taxation Система налогообложения. Перечисление с возможными значениями: * \"osn\" - общая СН; * \"usn_income\" - упрощенная СН (доходы); * \"usn_income_outcome\" - упрощенная СН (доходы минус расходы); * \"envd\" - единый налог на вмененный доход; * \"esn\" - единый сельскохозяйственный налог; * \"patent\" - патентная СН.
     *
     * @return $this
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\Model\Payments[]|null $payments Объект c информацией о видах суммы платежа. * Если объект не передан, будет автоматически указана итоговая сумма чека с видом оплаты \"Безналичный\". * Если передан объект **receipt.Payments**, то значение в **Electronic** должно быть равно итоговому значению Amount в методе **Init**. При этом сумма введенных значений по всем видам оплат, включая Electronic, должна быть равна сумме (Amount) всех товаров, переданных в объекте **receipt.Items**.
     *
     * @return $this
     */
