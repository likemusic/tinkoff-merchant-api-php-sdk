 ...
 * @link     https://openapi-generator.tech
 */
class ReceiptFFD105 implements ModelInterface, ArrayAccess
{
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ItemsFFD105[] $items Массив позиций чека с информацией о товарах
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string|null $phone Телефон клиента в формате +{Ц} Атрибут должен быть заполнен, если не передано значение  в атрибуте “Email”
     *
     * @return $this
     */
     ...
     * Sets taxation
     *
     * @param string $taxation Система налогообложения. Перечисление с возможными значениями: * \"osn\" - общая СН; * \"usn_income\" - упрощенная СН (доходы); * \"usn_income_outcome\" - упрощенная СН (доходы минус расходы); * \"envd\" - единый налог на вмененный доход; * \"esn\" - единый сельскохозяйственный налог; * \"patent\" - патентная СН.
     *
     * @return $this
     */
