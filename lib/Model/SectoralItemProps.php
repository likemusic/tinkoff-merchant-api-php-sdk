 ...
 *
 * @category Class
 * @description Отраслевой реквизит предмета расчета. Необходимо указывать только для товаров подлежащих обязательной маркировке средством идентификации и включение данного реквизита предусмотрено НПА отраслевого регулирования для соответствующей товарной группы.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SectoralItemProps implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['federal_id'] = isset($data['federal_id']) ? $data['federal_id'] : null;
     ...
     * Sets federal_id
     *
     * @param string $federal_id Идентификатор ФОИВ (федеральный орган исполнительной власти).
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param \DateTime $date Дата нормативного акта ФОИВ
     *
     * @return $this
     */
