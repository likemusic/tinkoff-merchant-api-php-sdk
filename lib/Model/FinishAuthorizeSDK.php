...
/**
 * FinishAuthorizeSDK Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class FinishAuthorizeSDK implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinishAuthorize_SDK';
    ...
    const SOURCE_CARDS = 'cards';
    const SOURCE_EINVOICING = 'einvoicing';
    const SOURCE_INSTALLMENT = 'Installment';
    const SOURCE_QRSBP = 'qrsbp';
    const SOURCE_BNPL = 'Bnpl';
    const SOURCE_MC = 'MC';
    const SOURCE_RC = 'RC';
    const SOURCE_VC = 'VC';
    const SOURCE_TINKOFF_PAY = 'TinkoffPay';
    const SOURCE_TINKOFF_WALLET = 'TinkoffWallet';
    const SOURCE_YANDEX_PAY = 'YandexPay';
    const SOURCE_UP = 'UP';
    const SOURCE_APPLE_PAY = 'ApplePay';
    const SOURCE_GOOGLE_PAY = 'GooglePay';
    ...
    public function getSourceAllowableValues()
    {
        return [
            ...
            self::SOURCE_RC,
            self::SOURCE_VC,
            self::SOURCE_TINKOFF_PAY,
            self::SOURCE_TINKOFF_WALLET,
            self::SOURCE_YANDEX_PAY,
            self::SOURCE_UP,
            self::SOURCE_APPLE_PAY,
            self::SOURCE_GOOGLE_PAY,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['encrypted_payment_data'] = isset($data['encrypted_payment_data']) ? $data['encrypted_payment_data'] : null;
     ...
     * Sets payment_id
     *
     * @param float $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы
     *
     * @return $this
     */
     ...
     * Sets ip
     *
     * @param string|null $ip IP-адрес клиента.  Обязательный параметр для 3DS второй версии. DS платежной системы требует  передавать данный адрес в полном формате,  без какихлибо сокращений (8 групп по 4 символа).  Данный формат регламентируется на уровне спецификации EMVCo.
     *
     * @return $this
     */
     ...
     * Sets send_email
     *
     * @param bool|null $send_email * true – отправлять клиенту информацию на почту об оплате * false – не отправлять
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string|null $source Источник платежа. Является обязательным для Apple Pay или Google Pay
     *
     * @return $this
     */
     ...
     * Sets info_email
     *
     * @param string|null $info_email Email для отправки информации об оплате. Обязателен при передаче SendEmai
     *
     * @return $this
     */
