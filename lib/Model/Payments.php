 ...
 *
 * @category Class
 * @description Детали платежа. Если объект не передан, будет автоматически указана итоговая сумма чека с видом оплаты \&quot;Безналичный\&quot;.  Если передан объект receipt.Payments, то значение в Electronic должно быть равно итоговому значению Amount в методе Init. При этом сумма введенных значений по всем видам оплат, включая Electronic, должна быть равна сумме (Amount) всех товаров, переданных в объекте receipt.Items.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Payments implements ModelInterface, ArrayAccess
{
     ...
     * Sets cash
     *
     * @param float|null $cash Вид оплаты \"Наличные\".  Сумма к оплате в копейках
     *
     * @return $this
     */
     ...
     * Sets electronic
     *
     * @param float $electronic Вид оплаты \"Безналичный\".
     *
     * @return $this
     */
     ...
     *
     * @param float|null $advance_payment Вид оплаты \"Предварительная оплата (Аванс)\".
     *
     * @return $this
     */
     ...
     * Sets credit
     *
     * @param float|null $credit Вид оплаты \"Постоплата (Кредит)\".
     *
     * @return $this
     */
     ...
     * Sets provision
     *
     * @param float|null $provision Вид оплаты \"Иная форма оплаты\".
     *
     * @return $this
     */
