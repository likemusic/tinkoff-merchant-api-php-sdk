 ...
 * @link     https://openapi-generator.tech
 */
class TinkoffPay implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TinkoffPay';
    ...
    const DEVICE_SDK = 'SDK';
    const DEVICE_DESKTOP = 'Desktop';
    const DEVICE_MOBILE_WEB = 'MobileWeb';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['device_web_view'] = isset($data['device_web_view']) ? $data['device_web_view'] : null;
        $this->container['device_browser'] = isset($data['device_browser']) ? $data['device_browser'] : null;
        $this->container['tinkoff_pay_web'] = isset($data['tinkoff_pay_web']) ? $data['tinkoff_pay_web'] : null;
    }
     ...
     * Sets device
     *
     * @param string|null $device Тип устройства * SDK (вызов из мобильных приложений) * Desktop (вызов из браузера с десктопа) * MobileWeb (вызов из браузера с мобильных устройств)
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $tinkoff_pay_web Признак проведения операции через Tinkoff Pay по API
     *
     * @return $this
     */
