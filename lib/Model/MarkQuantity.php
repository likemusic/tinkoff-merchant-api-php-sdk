 ...
 *
 * @category Class
 * @description Реквизит «дробное количество маркированного товара». Передается только в случае, если расчет осуществляется  за маркированный товар (соответствующий код в поле  paymentObject) и значение в поле measurementUnit  равно «0» &lt;br&gt; MarkQuantity не является обязательным объектом, в том числе для товаров с маркировкой. Этот объект МОЖНО передавать, если товар с маркировкой. Т.е. даже при ФФД 1.2 этот объект не является обязательным Пример:  &#x60;&#x60;&#x60;       {       \&quot;numenator\&quot;: \&quot;1\&quot;       \&quot;denominator\&quot; \&quot;2\&quot;         } &#x60;&#x60;&#x60;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MarkQuantity implements ModelInterface, ArrayAccess
{
     ...
     * Sets numerator
     *
     * @param float|null $numerator Числитель дробной части предмета расчета.  Значение должно быть строго меньше значения реквизита «знаменатель»
     *
     * @return $this
     */
     ...
     * Sets denominator
     *
     * @param float|null $denominator Знаменатель дробной части предмета расчета.  Значение равно количеству товара в партии (упаковке),  имеющей общий код маркировки товара.
     *
     * @return $this
     */
