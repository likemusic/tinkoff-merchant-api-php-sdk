...
class InlineResponse200 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['three_ds_method_url'] = isset($data['three_ds_method_url']) ? $data['three_ds_method_url'] : null;
        $this->container['payment_system'] = isset($data['payment_system']) ? $data['payment_system'] : null;
     ...
     * Sets version
     *
     * @param string $version Версия протокола 3DS.  Пример: * \"1.0.0” – первая версия * “2.1.0” – вторая версия
     *
     * @return $this
     */
     ...
     *
     * @param string|null $tds_server_trans_id Уникальный идентификатор транзакции, генерируемый 3DS-Server, обязательный параметр для 3DS второй версии.
     *
     * @return $this
     */
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling InlineResponse200., must be smaller than or equal to 20.');
        }
