...
class Member implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_payee'] = isset($data['is_payee']) ? $data['is_payee'] : null;
    }
     ...
     * Sets is_payee
     *
     * @param bool $is_payee * true - если данный участник был получателем указанного платежа,  * false - в противном случае
     *
     * @return $this
     */
