...
/**
 * InitPayments Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InitPayments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitPayments';
    ...
    protected static $openAPITypes = [
        'container' => 'string',
        'terminal_key' => 'string',
        'payment_info' => '\OpenAPI\Client\Model\PaymentInfos',
        'payment_items' => 'array',
    ...
    protected static $setters = [
        ...
        'payment_systems' => 'setPaymentSystems'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_items'] = isset($data['payment_items']) ? $data['payment_items'] : null;
        $this->container['payment_systems'] = isset($data['payment_systems']) ? $data['payment_systems'] : null;
    }
     ...
     * Sets container
     *
     * @param string|null $container ID элемента или элемент, в который вставляются кнопки
     *
     * @return $this
     */
     ...
     * Sets terminal_key
     *
     * @param string $terminal_key Идентификатор вашего магазина
     *
     * @return $this
     */
     ...
     * Gets payment_info
     *
     * @return \OpenAPI\Client\Model\PaymentInfos|null
     */
     ...
     * Sets payment_info
     *
     * @param \OpenAPI\Client\Model\PaymentInfos|null $payment_info payment_info
     *
     * @return $this
     */
     ...
     * Sets payment_items
     *
     * @param array|null $payment_items Список объектов с информацией о размещаемых кнопках
     *
     * @return $this
     */
    ...
    /**
     * Gets payment_systems
     *
     * @return object|null
     */
    public function getPaymentSystems()
    {
        return $this->container['payment_systems'];
    }

    /**
     * Sets payment_systems
     *
     * @param object|null $payment_systems Объект с информацией о платежных системах
     *
     * @return $this
     */
    public function setPaymentSystems($payment_systems)
    {
        $this->container['payment_systems'] = $payment_systems;
