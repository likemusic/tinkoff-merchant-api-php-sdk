...
class InlineResponse2001 implements ModelInterface, ArrayAccess
{
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling InlineResponse2001., must be smaller than or equal to 20.');
        }
    ...
    public function setOrderId($order_id)
    {
        if ((mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling InlineResponse2001., must be smaller than or equal to 36.');
        }
     ...
     * Sets status
     *
     * @param string $status Статус платежа   Получает в ответе 1 из 2 статусов: * CONFIRMED - Если платеж выполнен * REJECTED - Если платеж не выполнен
     *
     * @return $this
     */
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling InlineResponse2001., must be smaller than or equal to 20.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling InlineResponse2001., must be smaller than or equal to 20.');
        }
