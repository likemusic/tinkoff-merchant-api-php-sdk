 ...
 * @link     https://openapi-generator.tech
 */
class GetTerminalPayMethodsResponse implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['terminal_info'] = isset($data['terminal_info']) ? $data['terminal_info'] : null;
        $this->container['terminal_info_paymethods'] = isset($data['terminal_info_paymethods']) ? $data['terminal_info_paymethods'] : null;
        $this->container['terminal_info_add_card_scheme'] = isset($data['terminal_info_add_card_scheme']) ? $data['terminal_info_add_card_scheme'] : null;
        $this->container['terminal_info_token_required'] = isset($data['terminal_info_token_required']) ? $data['terminal_info_token_required'] : null;
        $this->container['terminal_info_init_token_required'] = isset($data['terminal_info_init_token_required']) ? $data['terminal_info_init_token_required'] : null;
    }
     ...
     * Sets success
     *
     * @param bool $success Успешность операции (true/false)
     *
     * @return $this
     */
     ...
     * Sets error_code
     *
     * @param string $error_code Код ошибки, «0» - если успешно
     *
     * @return $this
     */
