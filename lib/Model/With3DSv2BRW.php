 ...
 * @link     https://openapi-generator.tech
 */
class With3DSv2BRW extends FinishAuthorize 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'With3DSv2(BRW)';
     ...
     * Sets acs_url
     *
     * @param string|null $acs_url Если в ответе метода **FinishAuthorize** возвращается статус **3DS_CHECKING**,  Мерчанту необходимо сформировать запрос на URL ACS банка,  выпустившего карту (в ответе параметр `ACSUrl`) и вместе с этим перенаправить клиента на эту же страницу ACSUrl для прохождения 3DS
     *
     * @return $this
     */
