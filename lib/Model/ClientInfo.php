 ...
 *
 * @category Class
 * @description Информация по клиенту. Обязателен для товаров с маркировкой.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ClientInfo implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['documentode'] = isset($data['documentode']) ? $data['documentode'] : null;
     ...
     * Sets citizenship
     *
     * @param string|null $citizenship Числовой код страны, гражданином которой является клиент. Код страны указывается в соответствии с Общероссийским классификатором стран мира [ОКСМ](https://classifikators.ru/oksm)
     *
     * @return $this
     */
     ...
     * Sets document_data
     *
     * @param string|null $document_data Реквизиты документа, удостоверяющего личность (например: серия и номер паспорта)
     *
     * @return $this
     */
