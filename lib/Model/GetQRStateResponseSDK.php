...
/**
 * GetQRStateResponseSDK Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetQRStateResponseSDK implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQRStateResponse_SDK';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['qr_cancel_code'] = isset($data['qr_cancel_code']) ? $data['qr_cancel_code'] : null;
        $this->container['qr_cancel_message'] = isset($data['qr_cancel_message']) ? $data['qr_cancel_message'] : null;
     ...
     * Sets status
     *
     * @param string|null $status Статус платежа * Обязателен, если не произошло ошибки при получении статуса
     *
     * @return $this
     */
     ...
     *
     * @param string|null $qr_cancel_message Дополнительное описание ошибки, прозошедшей при возврате по QR
     *
     * @return $this
     */
