...
class InlineResponse2008 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'params' => '\OpenAPI\Client\Model\InlineResponse2008Params',
        'success' => 'bool',
        'error_code' => 'string',
        'message' => 'string',
        'details' => 'string'
     ...
     * Gets params
     *
     * @return \OpenAPI\Client\Model\InlineResponse2008Params
     */
     ...
     * Sets params
     *
     * @param \OpenAPI\Client\Model\InlineResponse2008Params $params params
     *
     * @return $this
     */
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling InlineResponse2008., must be smaller than or equal to 20.');
        }
