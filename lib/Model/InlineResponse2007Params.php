...
/**
 * InlineResponse2007Params Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse2007Params implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_7_Params';
     ...
     * Sets allowed
     *
     * @param bool $allowed Наличие возможности проведения оплаты Tinkoff Pay по API, SDK
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param string|null $version Версия Tinkoff Pay, доступная на терминале: * 1.0 (e-invoice) * 2.0 (Tinkoff Pay)
     *
     * @return $this
     */
