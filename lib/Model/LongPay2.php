 ...
 * @link     https://openapi-generator.tech
 */
class LongPay2 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['ticket_passenger_surname'] = isset($data['ticket_passenger_surname']) ? $data['ticket_passenger_surname'] : null;
        $this->container['ticket_passenger_firstname'] = isset($data['ticket_passenger_firstname']) ? $data['ticket_passenger_firstname'] : null;
        $this->container['passenger_passport'] = isset($data['passenger_passport']) ? $data['passenger_passport'] : null;
        $this->container['passenger_country'] = isset($data['passenger_country']) ? $data['passenger_country'] : null;
        $this->container['ticket_passenger_birth_date'] = isset($data['ticket_passenger_birth_date']) ? $data['ticket_passenger_birth_date'] : null;
    }
