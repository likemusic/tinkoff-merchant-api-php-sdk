 ...
 * @link     https://openapi-generator.tech
 */
class AddCardSDK implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddCard_SDK';
    ...
    const CHECK_TYPE_NO = 'NO';
    const CHECK_TYPE_HOLD = 'HOLD';
    const CHECK_TYPE__3_DS = '3DS';
    const CHECK_TYPE__3_DSHOLD = '3DSHOLD';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['check_type']) && !in_array($this->container['check_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'check_type', must be one of '%s'",
    ...
    public function setCustomerKey($customer_key)
    {
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling AddCardSDK., must be smaller than or equal to 36.');
        }
