 ...
 * @link     https://openapi-generator.tech
 */
class FinishAuthorize implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string $status Статус транзакции. Получает в ответе 1 из 4 статусов платежа:   * CONFIRMED - при одностадийной оплате   * AUTHORIZED - при двухстадийной оплате   * 3DS_CHECKING - при необходимости прохождения проверки 3-DSecure   * REJECTED - при неуспешном прохождении платежа
     *
     * @return $this
     */
     ...
     * Sets payment_id
     *
     * @param string|null $payment_id Идентификатор платежа в системе Тинькофф Кассы
     *
     * @return $this
     */
     ...
     * Sets card_id
     *
     * @param string|null $card_id Идентификатор карты в системе Тинькофф Кассы. Передается только для сохраненной карты
     *
     * @return $this
     */
