...
class InlineResponse2005 implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string $status Статус транзакции - CONFIRMED при успешном сценарии и одностадийном проведении платежа - AUTHORIZED при успешном сценарии и двухстадийном проведении платежа  - REJECTED при неуспешном
     *
     * @return $this
     */
     ...
     * Sets payment_id
     *
     * @param string $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы
     *
     * @return $this
     */
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling InlineResponse2005., must be smaller than or equal to 20.');
        }
