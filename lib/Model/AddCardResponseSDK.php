...
/**
 * AddCardResponseSDK Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AddCardResponseSDK implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddCardResponse_SDK';
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling AddCardResponseSDK., must be smaller than or equal to 20.');
        }
    ...
    public function setCustomerKey($customer_key)
    {
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling AddCardResponseSDK., must be smaller than or equal to 36.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling AddCardResponseSDK., must be smaller than or equal to 20.');
        }
     ...
     * Sets success
     *
     * @param bool $success Выполнение платежа
     *
     * @return $this
     */
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling AddCardResponseSDK., must be smaller than or equal to 255.');
        }
    ...
    public function setDetails($details)
    {
        if (!is_null($details) && (mb_strlen($details) > 255)) {
            throw new \InvalidArgumentException('invalid length for $details when calling AddCardResponseSDK., must be smaller than or equal to 255.');
        }
