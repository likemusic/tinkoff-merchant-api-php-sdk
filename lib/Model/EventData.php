...
class EventData implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'event_session_id' => 'setEventSessionId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['event_session_id'] = isset($data['event_session_id']) ? $data['event_session_id'] : null;
    }
     ...
     * Sets session_id
     *
     * @param string|null $session_id Идентификатор сессии Tinkoff Pay
     *
     * @return $this
     */
     ...
     * Sets access_token
     *
     * @param string|null $access_token Aвторизационный токен пользователя
     *
     * @return $this
     */
     ...
     * Sets account_id
     *
     * @param string|null $account_id Идентификатор счета оплаты
     *
     * @return $this
     */
    ...
    /**
     * Gets event_session_id
     *
     * @return string|null
     */
    public function getEventSessionId()
    {
        return $this->container['event_session_id'];
    }

    /**
     * Sets event_session_id
     *
     * @param string|null $event_session_id Идентификатор события
     *
     * @return $this
     */
    public function setEventSessionId($event_session_id)
    {
        $this->container['event_session_id'] = $event_session_id;
