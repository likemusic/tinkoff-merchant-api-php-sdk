 ...
 * @link     https://openapi-generator.tech
 */
class Without3DS extends FinishAuthorize 
{
     ...
     * Sets card_id
     *
     * @param string|null $card_id Идентификатор карты в системе Тинькофф Кассы.  Передается только для сохраненной карты.
     *
     * @return $this
     */
