 ...
 * @link     https://openapi-generator.tech
 */
class LongPay3 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['tripleg_date'] = isset($data['tripleg_date']) ? $data['tripleg_date'] : null;
        $this->container['tripleg_time'] = isset($data['tripleg_time']) ? $data['tripleg_time'] : null;
        $this->container['tripleg_carrier'] = isset($data['tripleg_carrier']) ? $data['tripleg_carrier'] : null;
        $this->container['tripleg_flight_number'] = isset($data['tripleg_flight_number']) ? $data['tripleg_flight_number'] : null;
        $this->container['tripleg_class'] = isset($data['tripleg_class']) ? $data['tripleg_class'] : null;
        $this->container['tripleg_destination_from'] = isset($data['tripleg_destination_from']) ? $data['tripleg_destination_from'] : null;
        $this->container['tripleg_destination_to'] = isset($data['tripleg_destination_to']) ? $data['tripleg_destination_to'] : null;
        $this->container['tripleg_country_from'] = isset($data['tripleg_country_from']) ? $data['tripleg_country_from'] : null;
        $this->container['tripleg_country_to'] = isset($data['tripleg_country_to']) ? $data['tripleg_country_to'] : null;
        $this->container['tripleg_stopover'] = isset($data['tripleg_stopover']) ? $data['tripleg_stopover'] : null;
        $this->container['tripleg_fare_basis_code'] = isset($data['tripleg_fare_basis_code']) ? $data['tripleg_fare_basis_code'] : null;
    }
