 ...
 * @link     https://openapi-generator.tech
 */
class NotificationPayment implements ModelInterface, ArrayAccess
{
     ...
     * Sets payment_id
     *
     * @param float|null $payment_id Уникальный идентификатор транзакции в системе Тинькофф Кассы
     *
     * @return $this
     */
     ...
     * Sets pan
     *
     * @param string|null $pan Замаскированный номер карты/Замаскированный номер телефона
     *
     * @return $this
     */
